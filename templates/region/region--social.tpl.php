 ...
 *   preprocess functions. The default values can be
 *   one or more of the following:
 *   - region: The current template type, i.e., "theming hook".
 *   - region-[name]: The name of the region with underscores replaced with
 *     dashes. For example, the page_top region would have a
 *     region-page-top class.
...
<?php if ($content): ?>
  <div class="<?php print $classes; ?>">
    <ul class="small-block-grid-1 large-block-grid-2"><?php print $content; ?></ul>
  </div>
<?php endif; ?>
