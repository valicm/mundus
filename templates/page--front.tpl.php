...
<body>
      ...
      <ul class="title-area">
        <li class="name">
         <ul id="quick-links">
           ...
           <li class="search"><a href="#" data-reveal-id="search-mundus"><?php print t('Search '); ?><i class="general-foundicon-search"></i></a>
            <div id="search-mundus" class="reveal-modal">
              <?php print $mundus_search; ?>
              <a class="close-reveal-modal"><i class="general-foundicon-remove"></i></a>
            </div>
          </li>
        <?php endif;?>
        <!-- end Mundus search  -->
        ...
        <li class="social"><a href="#" data-reveal-id="social-mundus"><?php print t('Social '); ?><i class="general-foundicon-people"></i></a>
  ...
  <li class="login"><a href="#" data-reveal-id="login-mundus"><?php print t('Log in '); ?><i class="general-foundicon-lock"></i></a>
